      ...
      <section className="relative py-32 px-6 bg-black overflow-hidden">
        ...
        <div className="relative max-w-[1000px] mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-6">
              <MessageSquare className="w-4 h-4 text-white" />
              <span className="text-sm text-white font-manrope">Contact Us</span>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-12 border border-white/10 shadow-2xl">
              ...
              <form className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="group relative">
                    <input
                      type="text"
                      placeholder="Name *"
                      className="w-full px-6 py-4 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-white/30 focus:bg-white/10 transition-all duration-300 outline-none font-manrope"
                    />
                ...
                {/* Inquiry Dropdown */}
                <div className="group relative">
                  <select className="w-full px-6 py-4 bg-white/5 border-2 border-white/10 rounded-xl text-white appearance-none focus:border-white/30 focus:bg-white/10 transition-all duration-300 outline-none cursor-pointer font-manrope">
                ...
                <div className="group relative">
                  <textarea
                    ...
                    className="w-full px-6 py-4 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-white/30 focus:bg-white/10 transition-all duration-300 outline-none resize-none font-manrope"
                  ></textarea>
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-white/0 via-white/5 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
                </div>
                ...
                <AnimatedButton 
                    ...
                    to="/"
                    className="px-8 py-4 rounded-full font-manrope font-medium text-sm bg-white text-black"
                    />
              ...
              {/* Floating Elements */}
              <div className="absolute -top-8 -right-8 w-16 h-16 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl rotate-12 backdrop-blur-sm border border-white/10"></div>
              <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-gradient-to-br from-white/10 to-white/5 rounded-full backdrop-blur-sm border border-white/10"></div>
            </div>

            {/* Additional Floating Card - Support Info */}
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-white mb-2 font-manrope">Call Us</h3>
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-white mb-2 font-manrope">Email Us</h3>
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-white mb-2 font-manrope">Visit Us</h3>
