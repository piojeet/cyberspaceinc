...
export default function HomeHero() {
    return (
        <section className='pt-[200px]'>
            <div className='max-w-[1440px] w-full mx-auto lg:px-8 px-4 grid grid-cols-2 gap-16'>
                <div className='space-y-4 content-center'>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#6366f1]/10 border border-[#6366f1]/20">
                        ...
                        <span className="text-sm text-[#6366f1] font-manrope">AI-Powered Innovation</span>
                    </div>
                    <h1 className='text-7xl font-manrope font-bold leading-tight'>
                        EXPLORE INNOVATIONS HERE
                    </h1>
                    <div className='text-2xl font-manrope'>
                        Welcome to Cyber Space Technologies
                    </div>
                    <p className='font-manrope leading-snug'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta maxime excepturi dolore quam, sed inventore deserunt rem numquam vel aliquam?</p>
                </div>
                ...
                <div>
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div className='bg-black p-4 flex flex-col justify-between rounded-lg'>
